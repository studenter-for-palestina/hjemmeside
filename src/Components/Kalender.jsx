        ...
        return (
            <div class = " p-4 m-4">
                <div class = "flex">
                    ...
                    <h1 class = "text-2xl font-bold underline px-2">{"" + event.date + " kl " + event.time }</h1>
                    <h1 class = "text-2xl px-2"> { " | " }</h1>
                    <h1 class = "text-2xl text-main_orange px-2"> {  event.location}</h1>
                </div>
                
                <p class = "text-main_green text-ellipsis overflow-hidden ">{event.description}</p>
                <a href = {event.link} class = "">Link til arragment</a>
            </div>
        )
    }
    return (
        <Fragment>
            <div class = "sm:grid sm:grid-cols-2 sm:gap-4 h-screen">
                ...
                <div class = "h-full ml-10 w-3/4 grid grid-cols-1 divide-y-2 divide-black overflow-y-auto">
