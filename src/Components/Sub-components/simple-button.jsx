function SimpleButton(obj){
    if (obj.span === "row-span-2"){
        return (         
            ...
            + "sm:grid sm:grid-rows-subgrid bg-main_green rounded-3xl shadow-3xl hover:bg-hover_green group w-full sm:h-full my-2"}>   
        ...
        return (     
        <div class={obj.row_loc + " " + obj.col_loc + " " + obj.span + " " 
        + " bg-main_green rounded-3xl shadow-3xl hover:bg-hover_green group w-full sm:h-full my-2"} >       
            <a href={obj.link} target="_blank">
